...
5. `Weekdays.tsx`:
Displays the days of the week as headers for the calendar. This static component enhances the calendar’s user interface by providing a clear label for each column corresponding to days of the week.
